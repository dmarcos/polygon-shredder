  ...
  this.update = function () {
    ...
    if ( gamepad !== undefined && gamepad.pose !== undefined ) {
      ...
      if ( thumbpadIsPressed !== gamepad.buttons[ 0 ].pressed ) {
        ...
        scope.dispatchEvent( { type: thumbpadIsPressed ? 'buttondown' : 'buttonup' } );
      ...
      if ( triggerIsPressed !== gamepad.buttons[ 1 ].pressed ) {
        ...
        scope.dispatchEvent( { type: triggerIsPressed ? 'buttondown' : 'buttonup' } );
      ...
      if ( gripsArePressed !== gamepad.buttons[ 2 ].pressed ) {
        ...
        scope.dispatchEvent( { type: gripsArePressed ? 'buttondown' : 'buttonup'} );
      ...
      if ( menuIsPressed !== gamepad.buttons[ 3 ].pressed ) {
        ...
        scope.dispatchEvent( { type: menuIsPressed ? 'buttondown' : 'buttonup' } );
...
THREE.TrackedController.prototype.constructor = THREE.ViveController;
